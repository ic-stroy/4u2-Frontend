      ...
      <div class="container d-flex profile_data-adaptive">
        ...
        <div>
          <div class="d-flex flex-column">
            ...
            <order-product-view :orders="orders"></order-product-view>
          </div>
        </div>
      </div>
    </section>
...
export default {
  ...
  data(){
    return{
      name:"Elyor",
      current_menu: {page:'profile_history'},
      orders:[
        {
          "id":1,
          ...
          "delivery_type":{
            ...
            "uz":"Kuryer yetkazib berish",
            "en":"Courier delivery"
          },
          "delivery_date":"13.03.2023",
          "sum":"950 000 sum",
          "img":"Rectangle44.png",
        },
        {
